...
const Register = () => {
  ...
  return (
    <div className="min-h-[calc(100-64px)] bg-[#f5f5f5] flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <h2 className="mt-6 text-2xl font-extrabold text-gray-900">Create your account</h2>
          ...
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 text-[#00b67a] focus:ring-[#00b67a] border-gray-300 rounded"
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                I agree to the{' '}
                <a href="#" className="font-medium text-[#00b67a] hover:text-[#009966]">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="#" className="font-medium text-[#00b67a] hover:text-[#009966]">
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-[#00b67a] hover:bg-[#009966] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00b67a] transition-all ${
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="font-bold text-[#00b67a] hover:text-[#009966]">
            Log in here
          </Link>
        </p>
      </div>
