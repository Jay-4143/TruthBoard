            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
               ...
               <button 
                type="submit"
                disabled={loading}
                className="w-full bg-[#1c55fd] text-white font-bold py-4 rounded-[3px] hover:bg-[#1541c4] transition-colors mt-6 text-base disabled:opacity-50"
              >
              ...
              <form onSubmit={onVerifyOTP} className="space-y-6 pt-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    maxLength="6"
                    className="w-full px-4 py-4 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-[#1c55fd] transition-all text-center text-3xl tracking-[0.5em] font-bold shadow-inner"
                    placeholder="000000"
                    value={otp}
                ...
                <div className="space-y-4 pt-4">
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="w-full bg-[#1c55fd] text-white py-4 rounded-lg font-bold text-base hover:bg-[#1541c4] transition-all disabled:opacity-50 shadow-lg"
                  >
                  ...
                  <div className="text-center group">
                    <button 
                      ...
                      className={`text-sm font-bold ${timer > 0 ? 'text-gray-400' : 'text-[#1c55fd] hover:underline'}`}
                    >
                  ...
                  <button 
                    ...
                    className="w-full text-center text-gray-400 text-xs font-bold hover:text-gray-600 transition-colors uppercase tracking-widest pt-2"
                  >
                    Change Details
                  </button>
                </div>
